...
# Hosts allowed to connect (for production update this)
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # ✅ Recommended: use a central templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'Asia/Kolkata'  # ✅ Better for India-based project
USE_I18N = True
USE_L10N = True
USE_TZ = True
